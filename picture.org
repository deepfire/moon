...
*** Event handling
      ...
      - NodeEditor.Event.Processor.[[file:node-editor/src/NodeEditor/Event/Processor.hs::scheduleEvent%20::%20LoopRef%20->%20Event%20->%20IO%20()][scheduleEvent]] <- [[file:node-editor/src/NodeEditor/Event/Processor.hs::scheduleInit%20::%20LoopRef%20->%20IO%20()][scheduleInit]]
        - NodeEditor.Event.Processor.[[file:node-editor/src/NodeEditor/Event/Processor.hs::processEvent%20::%20LoopRef%20->%20Event%20->%20IO%20()][processEvent]]
          - [[file:node-editor/src/NodeEditor/Event/Processor.hs::preprocessEvent%20::%20Event%20->%20IO%20Event][preprocessEvent]]
            - net :: NE.Event.Preprocessor.Batch.[[file:node-editor/src/NodeEditor/Event/Preprocessor/Batch.hs::handlers%20::%20Map.Map%20String%20(ByteString%20->%20Batch.Event)][handlers]]
            - NE.Ev.Preprocessor.Shortcut.[[file:node-editor/src/NodeEditor/Event/Preprocessor/Shortcut.hs::process%20::%20Event%20->%20Maybe%20Event][process]]
              - NE.Ev.KeyMap.[[file:node-editor-view/src/NodeEditor/Event/KeyMap.hs::handleKeyApp%20::%20KeyboardEvent%20->%20Maybe%20Command][handleKeyApp]]
          - [[file:node-editor/src/NodeEditor/Event/Filter.hs::filterEvents%20state%20event%20action%20=%20do][filterEvents]] $ [[file:lib/src/Common/Action/Command.hs::execCommand%20::%20Command%20a%20b%20->%20a%20->%20IO%20a][execCommand]] ([[file:node-editor/src/NodeEditor/Event/Processor.hs::runCommands%20::%20%5BEvent%20->%20Maybe%20(Command%20State%20())%5D%20->%20Event%20->%20Command%20State%20()][runCommands]] ([[file:node-editor/src/NodeEditor/Event/Processor.hs::actions%20::%20LoopRef%20->%20%5BEvent%20->%20Maybe%20(Command%20State%20())%5D][actions]] loop) realEvent)
            - NodeEditor.Handler.Searcher.[[file:node-editor/src/NodeEditor/Handler/Searcher.hs::handle%20_%20(Shortcut%20(Shortcut.Event%20Shortcut.SearcherOpen%20arg))][handle]] Shortcut.SearcherOpen
              - NodeEditor.Action.Searcher.[[file:node-editor/src/NodeEditor/Action/Searcher.hs::open%20mayPosition%20=%20do][open]]
                - Searcher.[[file:node-editor/src/NodeEditor/Action/Searcher.hs::openWith%20input%20mode%20=%20do][openWith]]
                  ...
                  - JS.Searcher.[[file:node-editor-view/src/JS/Searcher.hs::focus%20=%20UI.focus%20searcherId][focus]]
    ...
    - NodeEditor.React.View.App.[[file:node-editor-view/src/NodeEditor/React/View/App.hs::app%20::%20HasApp%20a%20=>%20ReactStore%20a%20->%20ReactView%20()][app]]
      - NodeEditor.Event.KeyMap.[[file:node-editor-view/src/NodeEditor/Event/KeyMap.hs::isEventHandled%20::%20KeyboardEvent%20->%20Bool][isEventHandled]]
    - NodeEditor.Handler.Searcher.[[file:node-editor/src/NodeEditor/Handler/Searcher.hs::handle%20_%20(Shortcut%20(Shortcut.Event%20Shortcut.SearcherOpen%20arg))][handle]] Shortcut.SearcherOpen
      - NodeEditor.Action.Searcher.[[file:node-editor/src/NodeEditor/Action/Searcher.hs::openWith%20::%20Text%20->%20Mode.Mode%20->%20Command%20State%20()][openWith]] <- [[file:node-editor/src/NodeEditor/Action/Searcher.hs::open%20mayPosition%20=%20do][open]]
        - begin Searcher
        - modifySearcher
        - adjustCameraToSearcher
        - setInput
        - Searcher.focus
*** Searcher
    ...
    - View.Searcher.[[file:~/luna-studio/frontend/node-editor-view/src/NodeEditor/React/View/Searcher.hs::searcher%20::%20IsRef%20ref%20=>%20ReactView%20(ref,%20Searcher.Properties)][searcher]]
...
* Lift
  - [[file:common/shell.nix::ghc.shellFor%20{][shell.nix]] | [[file:common/common.cabal::build-depends:][common]] [[file:lift/lift.cabal::build-depends:%20common][lift]] | [[file:common/nix/overrides.nix::pkgs:%20new:%20old:][overrides.nix]] | [[file:common/nix/github.json::{][nix/github.json]]
  - [[file:lift/src/CLI.hs::main%20=%20do][CLI]]
  - [[file:lift/src/Lift.hs::haskellServer%20env@Env{..}%20=][Lift]]
    - [[file:lift/src/Lift/Haskell.hs::module%20Lift.Haskell][Lift.Haskell]] [[file:lift/src/Lift/Haskell.hs::fileToModule%20libDir%20hsFile%20=%20do][fileToModule]]
    - [[file:lift/src/Lift/Hackage.hs::import%20Face.Haskell][Lift.Hackage]]
  - [[file:common/src/Wire/Peer.hs::serverPeer%20::%20forall%20rej%20m%20a][Peer]]
  - [[file:common/src/Wire/Protocol.hs::data%20Haskell][Protocol]]
  - [[file:common/src/Type.hs::data%20HaskellRequest%20(k%20::%20Kind)%20a%20where][Face]]
    - [[file:common/src/Ground/Haskell.hs::module%20Ground.Haskell][Ground.Haskell]]
* Backend
  - main
    - runApp
      - Engine.scheduleEvent loop Event.Init == Engine.scheduleInit loop
        - Loop.schedule loop . processEvent loop
      ...
      - Engine.connectEventSources socket loop
        - sequence_ $ mkSource <$> [ JSHandlers.webSocketHandler conn, JSHandlers.atomHandler, JSHandlers.sceneResizeHandler, JSHandlers.movementHandler]
